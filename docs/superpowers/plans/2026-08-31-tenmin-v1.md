...
Run: `uv run pytest -q`
Expected: PASS，301 passed, 6 skipped（5 个 generalize + 1 个 llm）

各文件预期数：timecode 14、models 10、config 8、srt_parser 11、clean 23、credits 13、normalize 19、gaps 21、density 18、aggregate 15、prompt 12、llm 9、budget 16、validate 20、single 19、table 22、narration 8、pipeline 18、cli 11、e2e 14（+1 skip）、generalize 0（+5 skip）。数字对不上就说明有测试写漏了，回头补。
